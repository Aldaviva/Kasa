...
public class KasaOutletScheduleTest: AbstractKasaOutletTest {
    ...
    public async Task Insert() {
        ...
        Schedule actual = await Outlet.Schedule.Save(new Schedule(true, [DayOfWeek.Tuesday, DayOfWeek.Wednesday, DayOfWeek.Thursday], new TimeOnly(7 + 12, 45)));
    ...
    public void SunRelative() {
        Schedule schedule = new(true, [DayOfWeek.Sunday], Schedule.Basis.Sunset, TimeSpan.FromMinutes(5));
